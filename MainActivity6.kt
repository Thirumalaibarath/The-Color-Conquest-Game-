...
val score = mutableStateListOf<Int>().apply {
    repeat(globalRow.toInt() * globalColumn.toInt()) { add(0) }
}
...
fun Cell(
    ...
    {
        if(globalRow.toInt() <4)  90 else 65
    }
    ...
    {
        if(globalRow.toInt() <4)  70 else 45
    }
    else if(globalColumn.toInt() == 6)
    {
        if(globalRow.toInt() <4)  60 else 45
    }
...
fun ExitButton()
{
    ...
    {
        Text(text = "X" , modifier = Modifier.offset(348.dp,15.dp), fontWeight = androidx.compose.ui.text.font.FontWeight.Bold, fontSize = 30.sp, color = Color.Gray)
    }
}
...
fun BoxWithText(modifier: Modifier = Modifier, color: Color, word: Int) {
    ...
    Box(
        ...
        {
            if(globalRow.toInt() <4)  60 else 60

        }
        else if(globalColumn.toInt() == 4)
        {
            if(globalRow.toInt() <4)  60 else 50
        }
        else if(globalColumn.toInt() == 5)
        {
            if(globalRow.toInt() <4)  50 else 50
        }
        else if(globalColumn.toInt() == 6)
        {
            40
        ...
        {
            if(globalRow.toInt() <4)  40 else 50
        }
        else if(globalColumn.toInt() == 4)
        {
            if(globalRow.toInt() <4)  40 else 40
        }
        else if(globalColumn.toInt() == 5)
        {
            if(globalRow.toInt() <4)  30 else 30
        }
        else if(globalColumn.toInt() == 6)
        {
            30
...
fun PlayerNameTwoDisplay()
{
...

    {
        Row(verticalAlignment = Alignment.CenterVertically)
        {
            ...
            Text(text = playerNameTwo, fontSize = 35.sp, fontWeight = FontWeight.Bold, color = lightBlue, modifier = Modifier.rotate(180f))
        }
    ...
    Box(
        modifier = Modifier
            ...
            .drawBehind {
                ...
                val textPainter = Paint().asFrameworkPaint().apply {
                    isAntiAlias = true
                    textSize = 35.sp.toPx()
